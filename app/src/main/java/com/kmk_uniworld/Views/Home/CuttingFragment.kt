 ...
 *
 */
class CuttingFragment : Fragment() {

    private lateinit var mRecyclerView: RecyclerView
    companion object {
     fun newInstance(): CuttingFragment = CuttingFragment()
    }
    ...
    fun generateTestData(): ArrayList<School> {
        ...
        for (i in 0..9) {
            var user: School = School(schoolId = "AUPSA1", schoolName = "AUP School Cherucode", orderStatus = true)
            result.add(user)
        }
